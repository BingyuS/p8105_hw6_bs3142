...
<img src="p8105_hw6_bs3142_files/figure-markdown_github/unnamed-chunk-4-1.png" width="90%" />
...
<img src="p8105_hw6_bs3142_files/figure-markdown_github/unnamed-chunk-4-2.png" width="90%" />
...
cv_3_models =
  cv_bwt %>%
  mutate(my_model = map(train, ~lm(bwt~babysex + delwt + gaweeks + mrace + parity + smoken + mheight + wtgain + bhead + menarche, data = .x)),
...
<img src="p8105_hw6_bs3142_files/figure-markdown_github/unnamed-chunk-10-1.png" width="90%" />
